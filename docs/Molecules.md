...
```jsx
import { Droplist } from 'occ-atomic';
...
```jsx
import { Autocomplete } from 'occ-atomic';
...
Here's an example:
```jsx
import { SubHeader, Button } from 'occ-atomic';
...
```jsx
import { LayerApp, Button } from 'occ-atomic';
...
Here's an example of how to implement it:
```jsx
import { SlideDown } from 'occ-atomic';
...
Here's an example:
```jsx
import { SwitchGroup } from 'occ-atomic';
